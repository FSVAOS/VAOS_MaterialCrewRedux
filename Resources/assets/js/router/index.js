...
export default new Router({
    routes: [
        ...
        {
            path: '/users/:id/logbook',
            name: 'profile_logbook',
            component: ProfileLogbookView
        },
        {
            path: '/users/:id/hanger',
            name: 'profile_hanger',
            component: ProfileHangerView
        },
        {
            path: '/users/:id/stats',
            name: 'profile_stats',
        ...
        {
            path: '/users/:id/hanger/:aircraft',
            name: 'aircraft_detailed',
            component: PersonalAircraftDetailedView
        },
        {
            path: '/settings',
            name: 'settings',
        ...
        },
        {
            path: '/settings/admin',
            name: 'settings_admin',
            component: InterfaceSettingsAdminView
        },
        {
            path: '/map',
            name: 'map',
            component: iFrameContainerView,
            meta: {frameUrl: "https://simvector.cardinalhorizon.com/"}
        }
    ]
});
